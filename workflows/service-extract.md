---
description: "[DEPRECATED] Extract service architecture - use existing_project_analysis workflows instead"
arguments:
  send: true
---
...
> **⚠️ DEPRECATED:** This workflow is deprecated. Use `existing_project_analysis` workflows instead for more comprehensive documentation.
>
> **Migration:** Copy `template/existing_project_analysis/` to your service repository and run:
> - `/generate-service-summary` — replaces this workflow's core output
> - `/generate-domain-glossary-v2` — domain terms + DDD patterns
> - `/generate-architecture-diagram-v2` — context, logical, security diagrams
> - `/generate-openapi-spec` — REST API contracts
> - `/generate-asyncapi-spec` — async/event contracts
>
> Output goes to `docs/[service-name]/` and can be copied to your aspec project's `docs/services/[service-name]/`.
